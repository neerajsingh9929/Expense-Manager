            ...
            <div class="col-md-5 col-xl-4">
                ...
                <div class="card">
                    ...
                    <div class="list-group list-group-flush" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action"  href="help.php" >
                            Help
                          </a>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="account" role="tabpanel">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="publicinfo.php"method="POST">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="2" class="form-control" id="inputBio" placeholder="Tell something about yourself"name="bio"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="privateinfo.php"method="POST">
                                    <div class="form-row">
                            ...
                            <div class="card-body">
                                ...
                                <form action="changepassword.php"method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="inputPasswordNew2"name="verifypassword">
                                    </div>
                                    <button type="submit" class="btn btn-primary">Save changes</button>
                                </form>
